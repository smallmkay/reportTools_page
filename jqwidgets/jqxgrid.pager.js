    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        _initpager: function() {
            ...
            if (!this.pagerrenderer) {
                ...
                this.pagershowsql = this.pagershowsql || a('<div type="button" style="padding: 0px;  margin-left: 3px; height:20px; width:80px; text-align:center; line-height:20px;  float: left;">查询SQL</div>');
                this.pagershowsqlinput = this.pagershowsqlinput || a('<textarea id='+this.element.id+'Sql style="display:none; padding: 0px;  margin-left: 3px; height:20px; width:80px; text-align:center; line-height:20px;  float: left;">请先查询后获取SQL！</textarea>');
                ...
                this.pagershowsql.attr("title","查询SQL");
                ...
                if (this.pagermode == "simple") {
                    ...
                    this.pagerdiv.append(this.pagershowsql)
                    this.pagerdiv.append(this.pagershowsqlinput)
                    
                }
                this.pagershowsql.jqxButton({
                  cursor: "pointer",
                  disabled: this.disabled,
                  theme: this.theme
                });
                var sqlid="#"+this.element.id+"Sql";
                this.removeHandler(this.pagershowsql, "click");
                this.addHandler(this.pagershowsql, "click",
                    function() {
		                	$.alert({
